...
* **Parameters:**
  ...
  * **terms_of_service_url** ([*str*](https://docs.python.org/3/library/stdtypes.html#str) *|* *None*) – 
  * **privacy_policy_url** ([*str*](https://docs.python.org/3/library/stdtypes.html#str) *|* *None*) – 
...
* **Parameters:**
  ...
  * **subtitle** ([*str*](https://docs.python.org/3/library/stdtypes.html#str) *|* *None*) – 
